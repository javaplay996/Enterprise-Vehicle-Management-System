...
<div>
	...
	<div class="news-preview" :style='{"width":"100%","margin":"0 auto","position":"relative","background":"none"}'>
		...
		<div class="list5 index-pv1" :style='{"padding":"10px 7%","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			<div :style='{"cursor":"pointer","padding":"0 0 20px","margin":"0 0 20px","borderColor":"#ccc","background":"none","borderWidth":"0 0 1px","display":"flex","width":"100%","borderStyle":"dashed","justifyContent":"space-between","height":"auto"}' v-for="item in newsList" :key="item.id" @click="toNewsDetail(item)" class="list-item animation-box">
				<el-image :style='{"width":"170px","padding":"20px","objectFit":"contain","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","display":"inline-block","height":"170px"}' :src="baseUrl + item.picture" :fit="fill"></el-image>
				<div class="item-info" :style='{"width":"calc(100% - 200px)","padding":"10px","display":"inline-block","height":"100%"}'>
					<div :style='{"padding":"0 10px","margin":"0 0 6px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(246,244,241,1) 20%, rgba(234,230,225,1) 50%, rgba(246,244,241,1) 80%, rgba(255,255,255,1) 100%),#a6937c","lineHeight":"32px","fontSize":"14px","textOverflow":"ellipsis","fontWeight":"600"}' class="title ">{{item.title}}</div>

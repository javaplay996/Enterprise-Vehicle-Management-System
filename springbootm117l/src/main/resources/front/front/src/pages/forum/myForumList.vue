...
<div :style='{"width":"100%","padding":"40px 7%","margin":"0 auto","position":"relative","background":"none"}'>
    <el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#333","borderRadius":"30px","background":"#e8d7c3","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="warning" size="mini" @click="backClick" class="el-icon-back">返回</el-button>
	<div class="section-title" :style='{"border":"1px dashed #7e6b5a","margin":"0 0 20px","outline":"1px solid #7e6b5a","color":"#333","outlineOffset":"2px","textAlign":"center","background":"#f6f5f3","fontSize":"20px","lineHeight":"36px"}'>我的发布</div>
    <el-table
      :data="tableData"
      style="width: 100%">
      <el-table-column

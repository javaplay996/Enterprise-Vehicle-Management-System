...
<div class="news" :style='{"padding":"0 7%","margin":"40px 0 0","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"100%","position":"relative","order":"3"}'>
	...
	<div class="title" :style='{"margin":"0 auto 20px","borderColor":"#7e6b5a","textAlign":"center","display":"flex","outline":"1px solid #7e6b5a","top":"0","outlineOffset":"2px","background":"#f6f5f3","borderWidth":"1px 0","width":"100%","position":"relative","borderStyle":"dashed","zIndex":"99","height":"56px"}'>
		<span :style='{"padding":"0 20px 0 100px","margin":"0 10px 0 0","color":"#4e4e4e","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230207/cb0df322e9b14cb3b11556207d9fab2b.png) no-repeat 20px -1px,#f6f5f3","width":"auto","fontSize":"18px","lineHeight":"56px","fontWeight":"600"}'>系统公告</span>
	</div>
...
<div class="lists" :style='{"padding":"0 0 60px","margin":"60px 7% 0","textAlign":"center","background":"none","display":"block","width":"86%","position":"relative","order":"30"}'>
	...
	<div class="title" :style='{"margin":"0 0 40px","borderColor":"#7e6b5a","alignItems":"flex-start","textAlign":"center","display":"flex","outline":"1px solid #7e6b5a","outlineOffset":"2px","background":"#f6f5f3","borderWidth":"1px 0","width":"auto","position":"relative","borderStyle":"dashed","height":"56px"}'>
	  <span :style='{"padding":"0 20px 0 100px","fontSize":"18px","lineHeight":"54px","color":"#4e4e4e","background":"url(http://codegen.caihongy.cn/20230207/cb0df322e9b14cb3b11556207d9fab2b.png) no-repeat 20px -1px,#f6f5f3","fontWeight":"600"}'>驾驶员展示</span>
	</div>
	...
	<div class="list list8 index-pv1" :style='{"padding":"0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		<div :style='{"width":"48%","flexWrap":"wrap","justifyContent":"space-between","display":"flex","height":"570px","order":"2"}' class="list-body">
			<div v-if="jiashiyuanList.length>0" @click="toDetail('jiashiyuanDetail', jiashiyuanList[0])" class="list-4-item animation-box item-1" :style='{"width":"48%","margin":"0","position":"relative","height":"auto","order":"2"}'>
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-if="preHttp(jiashiyuanList[0].touxiang)" :src="jiashiyuanList[0].touxiang.split(',')[0]" alt="" />
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-else :src="baseUrl + (jiashiyuanList[0].touxiang?jiashiyuanList[0].touxiang.split(',')[0]:'')" alt="" />
				<div class="list-4-item-title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(207,193,176,1) 20%, rgba(166,147,124,1) 50%, rgba(207,193,176,1) 80%, rgba(255,255,255,1) 100%),#a6937c","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>
                    <div>{{jiashiyuanList[0].xingming}}</div>
                    <div>驾证类型:{{jiashiyuanList[0].jiazhengleixing}}</div>
                </div>
			</div>
			<div v-if="jiashiyuanList.length>1" @click="toDetail('jiashiyuanDetail', jiashiyuanList[1])" class="list-4-item animation-box item-2" :style='{"width":"48%","margin":"0","position":"relative","height":"auto","order":"3"}'>
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-if="preHttp(jiashiyuanList[1].touxiang)" :src="jiashiyuanList[1].touxiang.split(',')[0]" alt="" />
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-else :src="baseUrl + (jiashiyuanList[1].touxiang?jiashiyuanList[1].touxiang.split(',')[0]:'')" alt="" />
				<div class="list-4-item-title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(207,193,176,1) 20%, rgba(166,147,124,1) 50%, rgba(207,193,176,1) 80%, rgba(255,255,255,1) 100%),#a6937c","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>
                    <div>{{jiashiyuanList[1].xingming}}</div>
                    <div>驾证类型:{{jiashiyuanList[1].jiazhengleixing}}</div>
                </div>
			</div>
			<div v-if="jiashiyuanList.length>2" @click="toDetail('jiashiyuanDetail', jiashiyuanList[2])" class="list-4-item animation-box item-3" :style='{"width":"100%","margin":"0 0 20px","position":"relative","height":"auto"}'>
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-if="preHttp(jiashiyuanList[2].touxiang)" :src="jiashiyuanList[2].touxiang.split(',')[0]" alt="" />
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-else :src="baseUrl + (jiashiyuanList[2].touxiang?jiashiyuanList[2].touxiang.split(',')[0]:'')" alt="" />
				<div class="list-4-item-title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(207,193,176,1) 20%, rgba(166,147,124,1) 50%, rgba(207,193,176,1) 80%, rgba(255,255,255,1) 100%),#a6937c","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>
                    <div>{{jiashiyuanList[2].xingming}}</div>
                    <div>驾证类型:{{jiashiyuanList[2].jiazhengleixing}}</div>
                </div>
			</div>
		</div>
		<div :style='{"width":"48%","margin":"0","flexWrap":"wrap","justifyContent":"space-between","display":"flex","height":"auto"}' class="list-body">
			<div v-if="jiashiyuanList.length>3" @click="toDetail('jiashiyuanDetail', jiashiyuanList[3])" class="list-4-item animation-box item-4" :style='{"width":"100%","margin":"0 0 20px","position":"relative","height":"auto"}'>
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-if="preHttp(jiashiyuanList[3].touxiang)" :src="jiashiyuanList[3].touxiang.split(',')[0]" alt="" />
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-else :src="baseUrl + (jiashiyuanList[3].touxiang?jiashiyuanList[3].touxiang.split(',')[0]:'')" alt="" />
				<div class="list-4-item-title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(207,193,176,1) 20%, rgba(166,147,124,1) 50%, rgba(207,193,176,1) 80%, rgba(255,255,255,1) 100%),#a6937c","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>
                    <div>{{jiashiyuanList[3].xingming}}</div>
                    <div>驾证类型:{{jiashiyuanList[3].jiazhengleixing}}</div>
                </div>
			</div>
			<div v-if="jiashiyuanList.length>4" @click="toDetail('jiashiyuanDetail', jiashiyuanList[4])" class="list-4-item animation-box item-5" :style='{"width":"100%","position":"relative","height":"auto"}'>
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-if="preHttp(jiashiyuanList[4].touxiang)" :src="jiashiyuanList[4].touxiang.split(',')[0]" alt="" />
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-else :src="baseUrl + (jiashiyuanList[4].touxiang?jiashiyuanList[4].touxiang.split(',')[0]:'')" alt="" />
				<div class="list-4-item-title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(207,193,176,1) 20%, rgba(166,147,124,1) 50%, rgba(207,193,176,1) 80%, rgba(255,255,255,1) 100%),#a6937c","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>
                    <div>{{jiashiyuanList[4].xingming}}</div>
                    <div>驾证类型:{{jiashiyuanList[4].jiazhengleixing}}</div>
                </div>
			</div>
		</div>
	</div>
	...
	<div @click="moreBtn('jiashiyuan')" :style='{"border":"0","padding":"0 20px","margin":"0 auto","textAlign":"center","display":"block","minWidth":"120px","right":"0","borderRadius":"8px","top":"8px","background":"none","width":"auto","lineHeight":"40px","position":"absolute","zIndex":"1010"}'>
		<span :style='{"color":"#333","fontSize":"15px"}'>查看更多</span>
		<i v-if="true" :style='{"color":"#333","fontSize":"15px"}' class="el-icon-d-arrow-right"></i>
	</div>
...
<div class="lists" :style='{"padding":"0 0 60px","margin":"60px 7% 0","textAlign":"center","background":"none","display":"block","width":"86%","position":"relative","order":"30"}'>
	...
	<div class="title" :style='{"margin":"0 0 40px","borderColor":"#7e6b5a","alignItems":"flex-start","textAlign":"center","display":"flex","outline":"1px solid #7e6b5a","outlineOffset":"2px","background":"#f6f5f3","borderWidth":"1px 0","width":"auto","position":"relative","borderStyle":"dashed","height":"56px"}'>
	  <span :style='{"padding":"0 20px 0 100px","fontSize":"18px","lineHeight":"54px","color":"#4e4e4e","background":"url(http://codegen.caihongy.cn/20230207/cb0df322e9b14cb3b11556207d9fab2b.png) no-repeat 20px -1px,#f6f5f3","fontWeight":"600"}'>车辆登记展示</span>
	</div>
	...
	<div class="list list8 index-pv1" :style='{"padding":"0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		<div :style='{"width":"48%","flexWrap":"wrap","justifyContent":"space-between","display":"flex","height":"570px","order":"2"}' class="list-body">
			<div v-if="cheliangdengjiList.length>0" @click="toDetail('cheliangdengjiDetail', cheliangdengjiList[0])" class="list-4-item animation-box item-1" :style='{"width":"48%","margin":"0","position":"relative","height":"auto","order":"2"}'>
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-if="preHttp(cheliangdengjiList[0].fengmian)" :src="cheliangdengjiList[0].fengmian.split(',')[0]" alt="" />
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-else :src="baseUrl + (cheliangdengjiList[0].fengmian?cheliangdengjiList[0].fengmian.split(',')[0]:'')" alt="" />
				<div class="list-4-item-title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(207,193,176,1) 20%, rgba(166,147,124,1) 50%, rgba(207,193,176,1) 80%, rgba(255,255,255,1) 100%),#a6937c","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>
                    <div>{{cheliangdengjiList[0].cheliangpinpai}}</div>
                    <div>{{cheliangdengjiList[0].chepaihao}}</div>
                </div>
			</div>
			<div v-if="cheliangdengjiList.length>1" @click="toDetail('cheliangdengjiDetail', cheliangdengjiList[1])" class="list-4-item animation-box item-2" :style='{"width":"48%","margin":"0","position":"relative","height":"auto","order":"3"}'>
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-if="preHttp(cheliangdengjiList[1].fengmian)" :src="cheliangdengjiList[1].fengmian.split(',')[0]" alt="" />
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-else :src="baseUrl + (cheliangdengjiList[1].fengmian?cheliangdengjiList[1].fengmian.split(',')[0]:'')" alt="" />
				<div class="list-4-item-title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(207,193,176,1) 20%, rgba(166,147,124,1) 50%, rgba(207,193,176,1) 80%, rgba(255,255,255,1) 100%),#a6937c","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>
                    <div>{{cheliangdengjiList[1].cheliangpinpai}}</div>
                    <div>{{cheliangdengjiList[1].chepaihao}}</div>
                </div>
			</div>
			<div v-if="cheliangdengjiList.length>2" @click="toDetail('cheliangdengjiDetail', cheliangdengjiList[2])" class="list-4-item animation-box item-3" :style='{"width":"100%","margin":"0 0 20px","position":"relative","height":"auto"}'>
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-if="preHttp(cheliangdengjiList[2].fengmian)" :src="cheliangdengjiList[2].fengmian.split(',')[0]" alt="" />
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-else :src="baseUrl + (cheliangdengjiList[2].fengmian?cheliangdengjiList[2].fengmian.split(',')[0]:'')" alt="" />
				<div class="list-4-item-title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(207,193,176,1) 20%, rgba(166,147,124,1) 50%, rgba(207,193,176,1) 80%, rgba(255,255,255,1) 100%),#a6937c","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>
                    <div>{{cheliangdengjiList[2].cheliangpinpai}}</div>
                    <div>{{cheliangdengjiList[2].chepaihao}}</div>
                </div>
			</div>
		</div>
		<div :style='{"width":"48%","margin":"0","flexWrap":"wrap","justifyContent":"space-between","display":"flex","height":"auto"}' class="list-body">
			<div v-if="cheliangdengjiList.length>3" @click="toDetail('cheliangdengjiDetail', cheliangdengjiList[3])" class="list-4-item animation-box item-4" :style='{"width":"100%","margin":"0 0 20px","position":"relative","height":"auto"}'>
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-if="preHttp(cheliangdengjiList[3].fengmian)" :src="cheliangdengjiList[3].fengmian.split(',')[0]" alt="" />
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-else :src="baseUrl + (cheliangdengjiList[3].fengmian?cheliangdengjiList[3].fengmian.split(',')[0]:'')" alt="" />
				<div class="list-4-item-title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(207,193,176,1) 20%, rgba(166,147,124,1) 50%, rgba(207,193,176,1) 80%, rgba(255,255,255,1) 100%),#a6937c","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>
                    <div>{{cheliangdengjiList[3].cheliangpinpai}}</div>
                    <div>{{cheliangdengjiList[3].chepaihao}}</div>
                </div>
			</div>
			<div v-if="cheliangdengjiList.length>4" @click="toDetail('cheliangdengjiDetail', cheliangdengjiList[4])" class="list-4-item animation-box item-5" :style='{"width":"100%","position":"relative","height":"auto"}'>
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-if="preHttp(cheliangdengjiList[4].fengmian)" :src="cheliangdengjiList[4].fengmian.split(',')[0]" alt="" />
				<img :style='{"padding":"40px","margin":"0 0 4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"400px"}' v-else :src="baseUrl + (cheliangdengjiList[4].fengmian?cheliangdengjiList[4].fengmian.split(',')[0]:'')" alt="" />
				<div class="list-4-item-title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(207,193,176,1) 20%, rgba(166,147,124,1) 50%, rgba(207,193,176,1) 80%, rgba(255,255,255,1) 100%),#a6937c","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>
                    <div>{{cheliangdengjiList[4].cheliangpinpai}}</div>
                    <div>{{cheliangdengjiList[4].chepaihao}}</div>
                </div>
			</div>
		</div>
	</div>
	...
	<div @click="moreBtn('cheliangdengji')" :style='{"border":"0","padding":"0 20px","margin":"0 auto","textAlign":"center","display":"block","minWidth":"120px","right":"0","borderRadius":"8px","top":"8px","background":"none","width":"auto","lineHeight":"40px","position":"absolute","zIndex":"1010"}'>
		<span :style='{"color":"#333","fontSize":"15px"}'>查看更多</span>
		<i v-if="true" :style='{"color":"#333","fontSize":"15px"}' class="el-icon-d-arrow-right"></i>
	</div>
      ...
      getSystemIntroduction() {
		...
		getList() {
          let autoSortUrl = "";
			...
			this.$http.get('jiashiyuan/list', {params: {
				page: 1,
				limit: 5,
			}}).then(res => {
				if (res.data.code == 0) {
					this.jiashiyuanList = res.data.data.list;
					
					// 商品列表样式五
					
				}
			});
			this.$http.get('cheliangdengji/list', {params: {
				page: 1,
				limit: 5,
			}}).then(res => {
				if (res.data.code == 0) {
					this.cheliangdengjiList = res.data.data.list;

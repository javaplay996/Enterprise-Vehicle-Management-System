...
<div :style='{"width":"100%","padding":"40px 7%","margin":"0 auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="维修项目" prop="weixiuxiangmu">
            <el-input v-model="ruleForm.weixiuxiangmu" 
                placeholder="维修项目" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="维修费用" prop="weixiufeiyong">
            <el-input v-model="ruleForm.weixiufeiyong" 
                placeholder="维修费用" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="情况说明" prop="qingkuangshuoming">
            <editor 

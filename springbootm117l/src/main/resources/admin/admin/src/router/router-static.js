...
import center from '@/views/center'
    ...
    import shiguxinxi from '@/views/modules/shiguxinxi/list'
    ...
    import cheliangdengji from '@/views/modules/cheliangdengji/list'

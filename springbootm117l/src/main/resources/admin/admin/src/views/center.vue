<template>
  <div :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}'>
    ...
    >  
     <el-row>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='jiashiyuan'"  label="工号" prop="gonghao">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='jiashiyuan'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='jiashiyuan'"  label="身份证" prop="shenfenzheng">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='jiashiyuan'"  label="驾证类型" prop="jiazhengleixing">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='jiashiyuan'"  label="驾证号码" prop="jiazhenghaoma">
          <el-input v-model="ruleForm.jiazhenghaoma"               placeholder="驾证号码" clearable></el-input>
        </el-form-item>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="手机号" prop="mobile">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      if( 'jiashiyuan' ==this.flag && this.ruleForm.lianxidianhua&&(!isMobile(this.ruleForm.lianxidianhua))){
        this.$message.error(`联系电话应输入手机格式`);
        return
      }
      if( 'jiashiyuan' ==this.flag && this.ruleForm.shenfenzheng&&(!checkIdCard(this.ruleForm.shenfenzheng))){

<template>
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="车辆编号" prop="cheliangbianhao">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="日营运" prop="riyingyun">
					<el-input v-model="ruleForm.riyingyun" placeholder="日营运" clearable  :readonly="ro.riyingyun"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="日营运" prop="riyingyun">
					<el-input v-model="ruleForm.riyingyun" placeholder="日营运" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="营运里程" prop="yingyunlicheng">
					<el-input v-model="ruleForm.yingyunlicheng" placeholder="营运里程" clearable  :readonly="ro.yingyunlicheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="营运里程" prop="yingyunlicheng">
					<el-input v-model="ruleForm.yingyunlicheng" placeholder="营运里程" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="营运收入" prop="yingyunshouru">
					<el-input v-model="ruleForm.yingyunshouru" placeholder="营运收入" clearable  :readonly="ro.yingyunshouru"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="营运收入" prop="yingyunshouru">
					<el-input v-model="ruleForm.yingyunshouru" placeholder="营运收入" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="工资收入" prop="gongzishouru">
					<el-input v-model="ruleForm.gongzishouru" placeholder="工资收入" clearable  :readonly="ro.gongzishouru"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="工资收入" prop="gongzishouru">
					<el-input v-model="ruleForm.gongzishouru" placeholder="工资收入" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="线路" prop="xianlu">
					<el-input v-model="ruleForm.xianlu" placeholder="线路" clearable  :readonly="ro.xianlu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="线路" prop="xianlu">
					<el-input v-model="ruleForm.xianlu" placeholder="线路" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="地点" prop="didian">
					<el-input v-model="ruleForm.didian" placeholder="地点" clearable  :readonly="ro.didian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="地点" prop="didian">
					<el-input v-model="ruleForm.didian" placeholder="地点" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="出车时间" prop="chucheshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.chucheshijian" 
						type="datetime"
						:readonly="ro.chucheshijian"
						placeholder="出车时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.chucheshijian" label="出车时间" prop="chucheshijian">
					<el-input v-model="ruleForm.chucheshijian" placeholder="出车时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="返回时间" prop="fanhuishijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.fanhuishijian" label="返回时间" prop="fanhuishijian">
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='chucheshijian'){
							this.ruleForm.chucheshijian = obj[o];
							this.ro.chucheshijian = true;
							continue;
						}
						if(o=='fanhuishijian'){
            ...
            this.$http({
				url: `option/cheliangdengji/cheliangbianhao`,
				method: "get"
            }).then(({ data }) => {
				if (data && data.code === 0) {
			...
			cheliangbianhaoChange () {
				this.$http({
					url: `follow/cheliangdengji/cheliangbianhao?columnValue=`+ this.ruleForm.cheliangbianhao,
					method: "get"
				}).then(({ data }) => {
					if (data && data.code === 0) {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `cheliangyunying/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.cheliangyunyingCrossAddOrUpdateFlag = false;
						 this.parent.search();

	...
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="维修项目" prop="weixiuxiangmu">
					<el-input v-model="ruleForm.weixiuxiangmu" placeholder="维修项目" clearable  :readonly="ro.weixiuxiangmu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="维修项目" prop="weixiuxiangmu">
					<el-input v-model="ruleForm.weixiuxiangmu" placeholder="维修项目" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="维修费用" prop="weixiufeiyong">
					<el-input v-model="ruleForm.weixiufeiyong" placeholder="维修费用" clearable  :readonly="ro.weixiufeiyong"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="维修费用" prop="weixiufeiyong">
					<el-input v-model="ruleForm.weixiufeiyong" placeholder="维修费用" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="情况说明" prop="qingkuangshuoming">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.qingkuangshuoming" label="情况说明" prop="qingkuangshuoming">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.qingkuangshuoming"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.qingkuangshuoming = this.ruleForm.qingkuangshuoming.replace(reg,'../../../springbootm117l/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

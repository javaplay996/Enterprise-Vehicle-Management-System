	...
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="驾证类型" prop="jiazhengleixing">
					<el-select :disabled="ro.jiazhengleixing" v-model="ruleForm.jiazhengleixing" placeholder="请选择驾证类型" >
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="驾证类型" prop="jiazhengleixing">
					<el-input v-model="ruleForm.jiazhengleixing"
						placeholder="驾证类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="驾证号码" prop="jiazhenghaoma">
					<el-input v-model="ruleForm.jiazhenghaoma" placeholder="驾证号码" clearable  :readonly="ro.jiazhenghaoma"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="驾证号码" prop="jiazhenghaoma">
					<el-input v-model="ruleForm.jiazhenghaoma" placeholder="驾证号码" readonly></el-input>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jiazhenghaoma'){
							this.ruleForm.jiazhenghaoma = obj[o];
							this.ro.jiazhenghaoma = true;
							continue;
						}
						if(o=='touxiang'){
            ...
            this.jiazhengleixingOptions = "A,B,C".split(',')
